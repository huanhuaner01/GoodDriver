...
//		SimpleAdapter adapter =new SimpleAdapter(this.father ,listdata ,R.layout.lucklist_item ,new String[]{} ,new int[]{});
		...
		prizelist.add(new LuckyGuy<CharSequence, Object>("9*****@qq.com", "代金券800元"));
		prizelist.add(new LuckyGuy<CharSequence, Object>("23****", "代金券100元"));
		prizelist.add(new LuckyGuy<CharSequence, Object>("132****@qq.com", "代金券100元"));
		prizelist.add(new LuckyGuy<CharSequence, Object>("51******", "代金券500元"));
		prizelist.add(new LuckyGuy<CharSequence, Object>("87******", "代金券100元"));
		prizelist.add(new LuckyGuy<CharSequence, Object>("55******", "代金券100元"));
		prizelist.add(new LuckyGuy<CharSequence, Object>("76******@163.com", "代金券500元"));
